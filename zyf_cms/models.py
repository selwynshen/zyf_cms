...
class IllCase(BaseModel):
    ...
    dabian_zhuangtai = models.CharField(max_length=50, null=True, default="0")
    #0:未知   1:有  2:无
    ...
    shezhi = models.CharField(max_length=50, null=True, default="0")
    #0:未知 1:是  2:否
    chiheng_jianqing = models.IntegerField(max_length=2, null=True, default=0)
    #0:未知 1:红润  2:绛紫 3： 淡白 4： 暗红 5： 青色 6： 舌周围有红色圆点
    shese = models.IntegerField(max_length=2, null=True, default=0)
    #0:未知 1:黄腻  2:白苔 3： 黑苔 4： 灰苔 5： 苔薄 6： 苔厚 7： 润 8：燥 9：腐 10： 腻 11: 剥落苔
    shetai = models.CharField(max_length=50, null=True, default="0")

    #0:未知 1:有血丝 2:有黄斑 3： 干涩 4： 模糊 5： 不适
    yanjing = models.CharField(max_length=50, null=True, default="0")
    yanjing_beizhu = models.CharField(max_length=200, null=True, default="0")

    #0:未知 1： 正常 2:有麻木感 3:胀感 4： 冰凉5： 疼痛 6： 刺痛 7： 抽搐
    tuijiao_qingkuang = models.CharField(max_length=50, null=True, default="0")
    tuijiao_buwei = models.CharField(max_length=200, null=True, default="0")
    ...
    #0:未知 1： 1号 2:2号 3:中号
    minyuecha = models.CharField(max_length=50, null=True, default="0")
    minyuecha_yinyong_qingkuang = models.CharField(max_length=200, null=True, default="")

    #0:未知 1： 1号 2:2号 3:3号
    wuzisan = models.CharField(max_length=50, null=True, default="0")
    ...
    #0:未知 1： 会阴 2:关元 3:涌泉
    yuantangtie_tiefu_xuewei = models.CharField(max_length=50, null=True, default="0")

    #0:未知 1： 金匮肾气丸 2:六味地黄丸 3:知柏地黄丸 4： 人参归脾丸 5： 肾源
    fuzhuyaowu = models.CharField(max_length=50, null=True, default="0")
    #0:未知 1： 正常剂量 2:翻倍剂量
    ...
    yuantangguang_buwei = models.CharField(max_length=50, null=True, default="0")
    #0:未知 1： 不出汗 2:微汗 3： 正常 4： 大汗 5: 禁用
    yuantangguang_chuhan_qingkuang = models.IntegerField(max_length=5, null=True, default=0)
    #0:未知 1：无 2：腿部 3： 腹部关元穴4： 背部
    yuantangguang_fuyao_qingkuang = models.CharField(max_length=50, null=True, default="0")
